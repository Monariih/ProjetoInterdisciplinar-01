...
public class Principal {
    ...
    private static final String menu = "Consecionária Auto City\n\n"
            + "1 --> Cadastrar Veiculo\n"
            + "2 --> Editar Veiculo\n"
            + "3 --> Excluir Veiculo\n"
    ...
    private static final String menuCadastroVeiculo = "Consecionária Auto City\n\n"
            + "1 --> Cadastrar Carro\n"
            + "2 --> Cadastrar Moto\n"
            + "3 --> Cadastar Caminhão\n\n"
            + "4 --> Voltar\n";
    
    private static final String selecaoExibicao = "Consecionária Auto City\n\n"
    ...
    private static final String menuDeletar ="Consecionária Auto City\n\n"
    ...
    private static final String menuAlterar = "Consecionária Auto City\n\n"
            ...
            switch(opcaoA){
                case 1:
                    if(listaDeCarros.isEmpty()){ //Tratamento de erro caso a lista esteja vazia
                        ...
                        int index = Integer.parseInt(JOptionPane.showInputDialog("Consecionária Auto City\n\n" + "Insira o codigo de cadastro do veiculo que você deseja alterar" + 
